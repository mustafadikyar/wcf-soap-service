...
namespace ProductService
{
    ...
    public interface IProductService
    {
        ...
        System.Threading.Tasks.Task<ProductService.Product> GetByIdAsync(string id);
        ...
        System.Threading.Tasks.Task<ProductService.Product[]> GetAllAsync();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IProductService/Post", ReplyAction="http://tempuri.org/IProductService/PostResponse")]
        System.Threading.Tasks.Task<ProductService.Product> PostAsync(ProductService.Product request);
    }
    ...
    public partial class ProductServiceClient : System.ServiceModel.ClientBase<ProductService.IProductService>, ProductService.IProductService
    {
        ...
        public System.Threading.Tasks.Task<ProductService.Product> GetByIdAsync(string id)
        {
            return base.Channel.GetByIdAsync(id);
        }
        
        public System.Threading.Tasks.Task<ProductService.Product[]> GetAllAsync()
        {
            return base.Channel.GetAllAsync();
        }
        
        public System.Threading.Tasks.Task<ProductService.Product> PostAsync(ProductService.Product request)
        {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpBinding_IProductService))
            {
                return new System.ServiceModel.EndpointAddress("http://localhost:53767/ProductService.svc");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
